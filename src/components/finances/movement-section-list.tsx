...
function entryKind(type: string) {
  return type === "income" || type === "salary_payment" || type === "exchange_in"
    ? "income"
    : type === "exchange_out"
      ? "transfer"
      : "expense";
      ...
      ListEmptyComponent={
        <View style={styles.emptyCard}>
          ...
          <Text style={styles.softText}>
            Registra ingresos, gastos o transferencias para ver actividad aqui.
          </Text>
        </View>
      }
      ListHeaderComponent={
          ...
          <View style={styles.listCard}>
            ...
            <View style={styles.listBody}>
              ...
              <Text style={styles.listMeta}>
                {meta} •{" "}
                {new Date(`${entry.date}T00:00:00.000Z`).toLocaleTimeString("en-US", {
                  hour: "2-digit",
                  minute: "2-digit",
                })}
              </Text>
